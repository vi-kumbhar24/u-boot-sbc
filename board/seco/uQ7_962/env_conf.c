...
video_mode_t video_mode_list [] = {
	{   
		...
		.panel_name = "LDB-WVGA",
#ifdef CONFIG_OF_LIBFDT_OVERLAY
		.dtbo_conf_file = STR(ENV_DTBO_uQ7_962_LVDS),
#else
		.dtbo_conf_file = "",
#endif
		...
		.panel_name = "LDB-WVGA",
#ifdef CONFIG_OF_LIBFDT_OVERLAY
		.dtbo_conf_file = STR(ENV_DTBO_uQ7_962_HDMI),
#else
		.dtbo_conf_file = "",
#endif
		...
		.panel_name = "LDB-WVGA",
#ifdef CONFIG_OF_LIBFDT_OVERLAY
		.dtbo_conf_file = STR(ENV_DTBO_uQ7_962_LDB_CLONE),
#else
		.dtbo_conf_file = "",
#endif
        .primary  = VIDEO_PRIMARY_LVDS,
		...
		.panel_name = "LDB-WVGA",
#ifdef CONFIG_OF_LIBFDT_OVERLAY
		.dtbo_conf_file = STR(ENV_DTBO_uQ7_962_LDB_DUAL),
#else
		.dtbo_conf_file = "",
#endif
        .primary  = VIDEO_PRIMARY_LVDS,
		...
		.panel_name = "LDB-WVGA",
#ifdef CONFIG_OF_LIBFDT_OVERLAY
		.dtbo_conf_file = STR(ENV_DTBO_uQ7_962_HDMI_LVDS),
#else
		.dtbo_conf_file = "",
#endif
        .primary  = VIDEO_PRIMARY_LVDS,
		...
		.panel_name = "HDMI",
#ifdef CONFIG_OF_LIBFDT_OVERLAY
		.dtbo_conf_file = STR(ENV_DTBO_uQ7_962_LVDS_HDMI),
#else
		.dtbo_conf_file = "",
#endif
        .primary  = VIDEO_PRIMARY_HDMI,
...
overlay_list_t overlay_peripheral_list [] = {
	{
		...
		.options = { 
			{ "flexcan", "" },		// default
			{ "uart4", STR(ENV_DTBO_uQ7_962_UART4) },
		},
	},
	{
		.title = "audio type",
		.options = { 
			...
			{ "AC97", STR(ENV_DTBO_uQ7_962_AC97) },
		},
	},
};
#endif  /* CONFIG_OF_LIBFDT_OVERLAY */