...
video_mode_t video_mode_list [] = {
	{   
		...
		.panel_name = "LDB-WVGA",
#ifdef CONFIG_OF_LIBFDT_OVERLAY
		.dtbo_conf_file = STR(ENV_DTBO_UQ7_J_A75_LVDS),
#else
		.dtbo_conf_file = "",
#endif
		...
		.panel_name = "LDB-WVGA",
#ifdef CONFIG_OF_LIBFDT_OVERLAY
		.dtbo_conf_file = STR(ENV_DTBO_UQ7_J_A75_HDMI),
#else
		.dtbo_conf_file = "",
#endif
		...
		.panel_name = "LDB-WVGA",
#ifdef CONFIG_OF_LIBFDT_OVERLAY
		.dtbo_conf_file = STR(ENV_DTBO_UQ7_J_A75_LDB_CLONE),
#else
		.dtbo_conf_file = "",
#endif
        .primary  = VIDEO_PRIMARY_LVDS,
		...
		.panel_name = "LDB-WVGA",
#ifdef CONFIG_OF_LIBFDT_OVERLAY
		.dtbo_conf_file = STR(ENV_DTBO_UQ7_J_A75_LDB_DUAL),
#else
		.dtbo_conf_file = "",
#endif
        .primary  = VIDEO_PRIMARY_LVDS,
		...
		.panel_name = "LDB-WVGA",
#ifdef CONFIG_OF_LIBFDT_OVERLAY
		.dtbo_conf_file = STR(ENV_DTBO_UQ7_J_A75_HDMI_LVDS),
#else
		.dtbo_conf_file = "",
#endif
        .primary  = VIDEO_PRIMARY_LVDS,
		...
		.panel_name = "HDMI",
#ifdef CONFIG_OF_LIBFDT_OVERLAY
		.dtbo_conf_file = STR(ENV_DTBO_UQ7_J_A75_LVDS_HDMI),
#else
		.dtbo_conf_file = "",
#endif
        .primary  = VIDEO_PRIMARY_HDMI,
...
overlay_list_t overlay_peripheral_list [] = {
	{
		...
		.options = { 
			{ "flexcan", "" },		// default
			{ "uart1", STR(ENV_DTBO_UQ7_J_A75_UART1) },
		},
	},
	{
		.title = "audio type",
		.options = { 
			...
			{ "AC97", STR(ENV_DTBO_UQ7_J_A75_AC97) },
		},
	},
};
#endif  /* CONFIG_OF_LIBFDT_OVERLAY */