...
void spl_dram_init(void)
{
	...
	if(C72_IS_4GB) {
		printf("C72 is 4GB\n");
		/* DDR Parameter */
		dram_timing.ddrc_cfg[8].val = 0x92014a;
                dram_timing.ddrc_cfg[27].val = 0x7070d0c;
                dram_timing.ddrc_cfg[29].val = 0x1809010e;
                dram_timing.ddrc_cfg[52].val = 0x7070707;
                dram_timing.ddrc_cfg[53].val = 0xf07;
                dram_timing.ddrc_cfg[76].val = 0x180037;
                dram_timing.ddrc_cfg[88].val = 0x2020d03;
                dram_timing.ddrc_cfg[90].val = 0xf03010e;
                dram_timing.ddrc_cfg[101].val = 0x6000e;
	}
