...
#define SECO_NUM_BOOT_DEV                        4  // eMMC, uSD, uSD on board, SPI Flash
...
#define CONFIG_SYS_PROMPT                        "MX6QDLS Q7-928 U-Boot > "
...
#define SCFG_DEFAULT_FDT_IMX6Q_FILE            "imx6q-seco_quadmo747_928.dtb"
#define SCFG_DEFAULT_FDT_IMX6DL_FILE           "imx6dl-seco_quadmo747_928.dtb"


/*  SCFG = SECO CONFIG  */
#define BOARD_BOOT_ID_EMMC                       0
#define BOARD_BOOT_ID_EXT_SD                     1
#define BOARD_BOOT_ID_ONBOARD_SD                 2

#define BOARD_ROOT_ID_EMMC                       0
#define BOARD_ROOT_ID_EXT_SD                     1
#define BOARD_ROOT_ID_ONBOARD_SD                 2



#define SCFG_KERNEL_BOOT_DEV_IMX6Q_NUM           7
#define SCFG_KERNEL_BOOT_DEV_IMX6DL_NUM          6

#define SCFG_FDT_BOOT_DEV_IMX6Q_NUM              7
#define SCFG_FDT_BOOT_DEV_IMX6DL_NUM             6

#define SCFG_RAMFS_BOOT_DEV_IMX6Q_NUM            8
#define SCFG_RAMFS_BOOT_DEV_IMX6DL_NUM           7

#define SCFG_ROOTFS_BOOT_DEV_IMX6Q_NUM           6
#define SCFG_ROOTFS_BOOT_DEV_IMX6DL_NUM          5



#define SCFG_BOOT_DEV_ID_EMMC                    __stringify(BOARD_BOOT_ID_EMMC)"\0"
#define SCFG_BOOT_DEV_ID_U_SD                    __stringify(BOARD_BOOT_ID_ONBOARD_SD)"\0"
...
#define SCFG_ROOT_DEV_ID_U_SD                    __stringify(BOARD_BOOT_ID_ONBOARD_SD)"\0"
